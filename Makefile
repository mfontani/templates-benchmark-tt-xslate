...
benchmark-5: clean-caches
	carton exec perl benchmark.pl 5
benchmark-10: clean-caches
	carton exec perl benchmark.pl 10

benchmark-0.5-f: clean-caches
	carton exec perl benchmark.pl -f 0.5
benchmark-1-f: clean-caches
	carton exec perl benchmark.pl -f 1
benchmark-5-f: clean-caches
	carton exec perl benchmark.pl -f 5
benchmark-10-f: clean-caches
	carton exec perl benchmark.pl -f 10
